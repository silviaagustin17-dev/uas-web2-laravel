        ...
        <div class="row">
            ...
            <div class="col-md-10 p-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fa-solid fa-pen-to-square text-warning me-2"></i> Edit Data Master Ruangan</h2>
                    <a href="{{ route('ruangan.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left me-1"></i> Kembali</a>
                </div>

                <div class="card shadow border-0">
                    <div class="card-header bg-warning text-white py-3">
                        <h5 class="mb-0"><i class="fa-solid fa-edit me-2"></i> Ubah Informasi Ruangan</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('ruangan.update', $ruangan->id) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
